...
namespace Project_Librari_Management.UI
{
    public partial class MainMenuUI : Form
    {
        ...
        private void showSelfOrderAndDoPdf_Click(object sender, EventArgs e)
        {
        ...
        {
            TodayOrderUI today=new TodayOrderUI();
            today.Show();
        }

        private void button16_Click(object sender, EventArgs e)
        {
            SimpleCalculationUI simple=new SimpleCalculationUI();
            simple.ShowDialog();
        }
    }
}
