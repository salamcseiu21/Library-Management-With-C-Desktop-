...
namespace Project_Librari_Management.UI
{
    public partial class ChangeUserAndPasswordUI : Form
    {
        ...
        private void CurrentUserNameTextBox_Validating(object sender, CancelEventArgs e)
        {
            if (CurrentUserNameTextBox.Text == "")
            {
                errorProvider1.SetError(CurrentUserNameTextBox, "Please! Write the Current User Name here.....!");

            }
            else
            {
                errorProvider1.SetError(CurrentUserNameTextBox, "");
            }
        }
        ...
        private void currentPasswordtExtBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                errorProvider1.SetError(currentPasswordtExtBox, "Please! Write the Current Password here.....!");
        ...
        private void newUserNameTextBxo_Validating(object sender, CancelEventArgs e)
        {
            if (newUserNameTextBxo.Text == "")
            {
                errorProvider1.SetError(newUserNameTextBxo, "Please! Write the New User Name here.....!");

            }
            else
            {
                errorProvider1.SetError(newUserNameTextBxo, "");
            }
        }
        ...
        private void newPasswordTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                errorProvider1.SetError(newPasswordTextBox, "Please! Write the New password here.....!");
        ...
        private void confirmPasswordTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                errorProvider1.SetError(confirmPasswordTextBox, "Please! confirm the new password here.....!");
