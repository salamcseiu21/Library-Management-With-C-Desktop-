                ...
                if (a.Equals("") || a.Equals("0"))
                {
                    if (cashTextBox.Text.Equals("0") || cashTextBox.Text.Equals(""))
                    {
                       ...
                       // GetAmountWithOrder();
                        GetallDueCollection();
                        GetTotalAdvance();
                        //double aa = Convert.ToDouble(GetTotalAdvance());
                        //double ddd = Convert.ToDouble(GetallDueCollection());
                        //matchTotalCashTextBox.Text =;
                    }
                    else
                    {
        ...
        private double GetTotalDueCollection(SqlConnection connection)
        {
            ...
            while (reader2.Read())
            {
                try
                {
                    ...
                    if (reader2[0].Equals("0") || reader2[0].Equals(""))
                    {
                    ...
                    {
                        due_Coll = Convert.ToDouble(reader2[0]) + sell_Book;
        ...
        public void GetallDueCollection()
        {
            ...
            while (reader2.Read())
            {
                try
                {
                    ...
                    {
                        totalDue = Convert.ToDouble(reader2[0]);
                        duecollectionTextBoxtext.Text = totalDue.ToString();
                    }
                }
                catch (InvalidCastException)
